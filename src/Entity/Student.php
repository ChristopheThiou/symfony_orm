...
class Student
{
    ...
    //Pour stopper la dépendance circulaire avec Note, je choisis de ne pas récupérer les notes quand je récupère les students
    #[ORM\OneToMany(mappedBy: 'student', targetEntity: Note::class, orphanRemoval: true)]
    private Collection $notes;

    #[ORM\ManyToMany(targetEntity: Promo::class, mappedBy: 'student')]
